...
```mermaid
    ...
    %% Subgraphs
        ...
        %% Assign Objects to nas25.j-j.family        
            ...
            subgraph docker-nas25 [Docker Daemon]
                ...
                subgraph authentication-stack
                    Keycloak
                    pg-keycloak[(               PostgresDB <br> for <br> Keycloak       )]
                end
        ...
        %% Draw Connections within pi-core
            ...
            pi-core-certbot     ---     | TCP 80                            | pi-core-ip10
            pi-core-ip10        ---     |                                   | pi-core-docker-net
            pi-core-ip10        --->    | TCP 443 / 53 / 636                | pi-core-nginx
            pi-core-docker-net  ----    |                                   | pi-core-nginx
            pi-core-docker-net   --->     | TCP 53 <br> UDP 53            | adguard-dns
            pi-core-docker-net   --->     | TCP 443 for Managment         | adguard-dns
        ...
        %% Draw Connections within nas25
            ...
            media-backend  --->    | TCP 5432                          | pg-keycloak
            media-backend  --->    | TCP 8443                          | Keycloak
